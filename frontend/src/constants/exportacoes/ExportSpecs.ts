import type { ExportSpec, NavItem } from '../../types/utilities/Economy';
...
export const EXPORT_SPECS: ExportSpec[] = [
  ...
  imageKey: 'bens-consumo',          // ← TROCOU de 'bens-consumo-valor' para 'bens-consumo'
  imageFolder: 'exportacoes',
  ...
  },
  {
    ...
    imageKey: 'bens-nao-duraveis-preco',
    imageFolder: 'exportacoes',
  ...
  },
  {
    ...
    imageKey: 'bens-intermediarios-quantum',
    imageFolder: 'exportacoes',
