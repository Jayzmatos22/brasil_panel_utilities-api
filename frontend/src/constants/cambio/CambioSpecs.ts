...
export const CAMBIO_SPECS: CambioContractedSpec[] = [
  ...
  // ─── Fluxo Comercial + Financeiro ────────────────────────────────────
  {
    ...
    imageKey: 'comercial-financeiro-exterior',
    imageFolder: 'cambioComercial',
