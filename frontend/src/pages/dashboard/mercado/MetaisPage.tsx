  ...
  return (
    <header className="px-5 sm:px-6 pt-5 pb-4 flex items-start justify-between flex-wrap gap-3 border-b border-slate-800/60">
      <div className="min-w-0">
        ...
        <h2 className="mt-1 text-sm font-semibold text-slate-100 tracking-tight">
          {title}
        </h2>
        {description && (
...
function StatePanel({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-14">
      <div
        className={`flex items-center justify-center w-11 h-11 rounded-full ring-1 ${ring}`}
      >
...
export default function MetaisPage() {
  ...
  const effectiveMetal: MetalKey = availableMetals.some(
    (m) => m.key === selected,
  )
    ? selected
      ...
      <motion.header variants={item} className="flex flex-col gap-2">
        <div className="flex items-start justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-amber-400/15 to-amber-500/5 ring-1 ring-amber-400/20">
              ...
              >
                ...
                {image && (
                  <>
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-slate-950/75 to-slate-950/30 pointer-events-none" />
                  </>
                )}
      ...
      <motion.div variants={item}>
        <SectionCard>
          <SectionHeader
            ...
            right={
              <>
                <label htmlFor="metal-select" className="sr-only">
                  Selecionar metal
                </label>
                <select
                  id="metal-select"
