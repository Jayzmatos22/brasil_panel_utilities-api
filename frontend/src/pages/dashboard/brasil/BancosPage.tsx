...
// ============================================================================
const BANCOS_IMAGES = import.meta.glob(
  "../../../assets/bancos/*.{jpeg,jpg,png,webp,avif}",
  {
    eager: true,
    import: "default",
  },
...
function findBancosImage(term: string): string | undefined {
  const match = Object.entries(BANCOS_IMAGES).find(([path]) =>
...
export default function BancosPage() {
  ...
  return (
    ...
    >
      ...
      <motion.header
        variants={item}
        className="group relative min-h-85 flex items-end bg-[#020617] rounded-2xl overflow-hidden"
        style={{
      ...
      >
        {headerImage ? (
          <>
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 60% 40%, #002776 0%, #FFDF00 30%, transparent 70%)",
              }}
            />
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 70% 65% at 70% 40%, transparent 0%, rgba(2,6,23,0.6) 40%, #020617 80%)",
              }}
            />

            {/* Subtle bottom gradient for text readability */}
            <div className="absolute bottom-0 left-0 right-0 h-[60%] z-2 bg-linear-to-t from-[#020617] via-[#020617]/50 to-transparent" />
          </>
        ) : (
        ...
        <div className="absolute left-0 top-0 bottom-0 w-[3px] z-[3] bg-linear-to-b from-[#002776] via-[#FFDF00] to-[#009C3B] shadow-[0_0_18px_rgba(255,223,0,0.4)]" />
        ...
        <div className="relative z-10 p-6 sm:p-10 w-full">
          ...
          <form
            ...
            className="flex flex-col sm:flex-row gap-3 max-w-2xl relative z-20"
          >
            <input
              type="number"
              value={codeInput}
      ...
      <motion.div
        variants={item}
        className="relative bg-white/2 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-[0_0_60px_-15px_rgba(250,204,21,0.05)]"
      >
        <div className="flex items-center justify-between mb-6 flex-wrap gap-4 bg-linear-to-r from-slate-900/80 via-slate-950/90 rounded-lg px-2">
